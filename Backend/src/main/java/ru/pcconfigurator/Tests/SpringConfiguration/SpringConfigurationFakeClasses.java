package ru.pcconfigurator.Tests.SpringConfiguration;
...
public class SpringConfigurationFakeClasses {
    ...
    @Bean
    List<Accessory> getFakeAccessories() {
        return  (List<Accessory>) List.of(getComputerCaseCooler120(), getComputerCaseCooler90(), getComputerCaseCooler75(), getComputerCase(),
                getComputerCaseSmall(), getCoolerLGA1150H70(),getCoolerLGA1150H150(),
                getCoolerLGA1700H70(), getCoolerLGA1700H150(), getCpuLGA1150(), getDiskM2(),
                getDiskSSD(), getGpu100(), getGpu170(), getCpuLGA1700(), getMotherBoard(), getMotherBoard2(), getMotherBoard3(), getMotherBoard4(),
                getPowerSupply550(), getPowerSupply850(), getPowerSupply550FlexATX(), getRamDDR3(), getRamDDR4());
    }

    @Bean
    List<PcConfiguration> getFakeConfigurations(){
        return List.of(getEmptyConfiguration(),getFullConfiguration(),getConfigurationWithSomeAccessories());
    }
}
